...
function pega_progresso(acao) {
 ...
 $("#DownloadInstrumento").live('click',function(){
    ...
    window.location = Drupal.settings.ferramenta2.url+'?q=avaliacao/download/1/'+acao;
 });
 
  $("#DownloadDados").live('click',function(){
    var acao=$(this).attr("value");
    window.location = Drupal.settings.ferramenta2.url+'?q=avaliacao/download/2/'+acao;    
 });
