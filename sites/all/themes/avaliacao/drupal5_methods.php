...
function avaliacao_breadcrumb($breadcrumb) {
  return art_breadcrumb_woker($breadcrumb);
}

function avaliacao_comment_wrapper($content, $type = null) {
  return art_comment_woker($content, $type = null);
}

function avaliacao_menu_local_tasks() {
 ...
 * @ingroup themeable
 */
function avaliacao_menu_local_task($mid, $active, $primary) {
