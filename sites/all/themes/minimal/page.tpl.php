...
<body class="<?php print $body_classes; ?>">
  <div id="page">
    <div id="header" class="container_12" >
      ...
      <?php if (!empty($header)): ?>
        <div id="header-region" style="left">
          <?php print $header; ?>
        </div>
      <?php endif; ?>
     <?php
    ...
    <div id="container" class="clear-block container_12">
      ...
      <?php if (!empty($left)): ?>
        <div id="sidebar-left" class="column sidebar grid_3">
          <?php print $left; ?>
        </div> <!-- /sidebar-left -->
      <?php endif; ?>
      ...
      <div id="main" class="column"><div id="main-squeeze">
        ...
        <div id="content" >
          ...
          <div id="content-content" class="clear-block grid_6 title">
            <?php print $content; ?>
          </div> <!-- /content-content -->
    ...
    <div id="footer-wrapper" class="container_12 topo">
        <div id="" class="grid_3 "> 
        <br/>
        </div>
        <div id="" class="grid_3 ">
